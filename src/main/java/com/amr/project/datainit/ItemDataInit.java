...
public class ItemDataInit {
    ...
    private void itemDataInit() {
        itemDao.persist(Item.builder().id(1L).name("White Wooden Table")
                ...
                .reviews(List.of(reviewDao.findById(1L))).build());

        itemDao.persist(Item.builder().id(2L).name("Black Wooden Table")
        ...
        itemDao.persist(Item.builder().id(3L).name("IPhone 15R")
        ...
        itemDao.persist(Item.builder().id(4L).name("Nokia 3310")
        ...
        itemDao.persist(Item.builder().id(5L).name("Adult Bicycle")
        ...
        itemDao.persist(Item.builder().id(6L).name("Child Pink Bicycle")
        ...
        itemDao.persist(Item.builder().id(7L).name("Swedish Chairs")
        ...
        itemDao.persist(Item.builder().id(8L).name("Chairs for Children")
